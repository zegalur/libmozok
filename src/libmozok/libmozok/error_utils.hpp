...
Result errorActionGroupAlreadyExists(const Str& serverWorldName, const Str& groupName) noexcept;
Result errorUndefinedActionGroup(const Str& serverWorldName, const Str& groupName) noexcept;
